---
title: "Grocery Buddy Product Design"
...
cover: ../../assets/projects/flow14-grocery-buddy/cover.svg
...
export const pics = globImages(
  import.meta.glob('../../assets/projects/flow14-grocery-buddy/*.svg', { eager: true })
);
