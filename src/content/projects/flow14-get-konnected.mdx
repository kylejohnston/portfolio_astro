---
title: "Get Konnected Website Design"
...
cover: ../../assets/projects/flow14-get-konnected/cover.svg
...
export const pics = globImages(
  import.meta.glob('../../assets/projects/flow14-get-konnected/*.svg', { eager: true })
);
