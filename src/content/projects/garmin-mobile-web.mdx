---
title: "Garmin Mobile-Optimized Ecommerce"
...
cover: ../../assets/projects/garmin-mobile-web/cover.svg
...
export const pics = globImages(
  import.meta.glob('../../assets/projects/garmin-mobile-web/*.svg', { eager: true })
);
