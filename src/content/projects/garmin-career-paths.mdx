---
title: "Garmin Career Path Planning and Design"
...
cover: ../../assets/projects/garmin-career-paths/cover.svg
...
export const pics = globImages(
  import.meta.glob('../../assets/projects/garmin-career-paths/*.svg', { eager: true })
);
