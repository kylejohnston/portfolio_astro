...
cover: ../../assets/projects/demo-design-system-migration/cover.svg
...
export const pics = globImages(
  import.meta.glob('../../assets/projects/demo-design-system-migration/*.svg', { eager: true })
);
...
<Span12 src={pics["full-bleed"]} alt="Token-based component library showing button, input, and card primitives" />
